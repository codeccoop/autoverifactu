...
;
    ...
    }else if($action === 'verifactuResend'){
        ...
        if ($thirdparty->country_code && $thirdparty->country_code !== 'ES') {
            ...
            if ($thirdparty->tva_intra) {
                ...
                if($thirdparty->array_options['options_verifactu_identification_thirdparty']=='03'){
                    ...
                    $recipient->type = '04';
                    $recipient->value = trim($thirdparty->idprof1);
                }else if($thirdparty->array_options['options_verifactu_identification_thirdparty']=='05'){
                    //CERTIFICADO DE RESIDENCIA (Residence Certificate)
                    $recipient->type = '05';
                    $recipient->value = trim($thirdparty->idprof1);
                }else if($thirdparty->array_options['options_verifactu_identification_thirdparty']=='06'){
                    //OTRO DOCUMENTO PROBATORIO (Other supporting document)
                    $recipient->type = '06';
                    $recipient->value = trim($thirdparty->idprof1);
                }else if($thirdparty->array_options['options_verifactu_identification_thirdparty']=='07'){
...
function autoverifactuSetLegalText($invoice){
    ...
    }else if(strlen($invoice->array_options["options_verifactu_pdfLegalText"])>0){
