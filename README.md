...
Puedes descargarte la última versión del código desde el listado de versiones disponibles ([GitHub 🐱](https://github.com/codeccoop/autoverifactu/tags) o [GitLab 🦊](https://gitlab.com/codeccoop/dolibarr/autoverifactu/-/releases)).
