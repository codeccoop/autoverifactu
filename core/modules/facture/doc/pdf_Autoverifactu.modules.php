...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_Verifactu.modules.php
 *	\ingroup    invoice
...
Parte superior izquierda si la factura es en formato vertical.
Lado izquierdo superior si la factura es en formato horizontal.
Solo en la primera página, en caso de facturas con múltiples páginas.
...
8. Tamaño del QR en las facturas
...
class pdf_Autoverifactu extends ModelePDFFactures
{
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		pdf_pagehead($pdf, $outputlangs, $this->page_hauteur);
			...
			superiores a los del resto de datos de la factura.
